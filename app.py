...
def generate_compliance_pdf(df, notice_draft, context):
    ...
    elements.append(Paragraph("DISCLAIMER: This report is generated by AI for advisory purposes. No admission of liability is intended.", styles["Disclaimer"]))
...
if uploaded_file:
    ...
    """
            ...
            st.text_area("Lawyer-Grade Reply", json_data["notice_reply_draft"], height=220)
